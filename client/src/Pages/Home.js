									...
									<div className="row d-flex">
													...
													<div className="card mt-2">
															<div className="card-body">
																	<div className="text-center">
																			<h4 className="font-up" style={style.h4}>About DigiFriend</h4>
																			<hr />
											...
											<div className="col d-flex">
													<div className="card mt-2">
															<div className="card-body">
																	<div className="text-center">
																			<h4 className="font-up"  style={style.h4}>DigiFriends</h4>
																			<hr />
											...
											<div className="col d-flex">
													<div className="card mt-2">
															<div className="card-body">
																	<div className="text-center">
																			<h4 className="font-up"  style={style.h4}>Custom Commands</h4>
																			<hr />
